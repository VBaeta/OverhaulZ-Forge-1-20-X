...
public class ModBiomes {
    public static final ResourceKey<Biome> TEST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(OverhaulZ.MOD_ID, "test_biome"));
    ...
    public static Biome testBiome(BootstapContext<Biome> context) {
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.LOST_SURVIVOR.get(), 2, 3, 5));
